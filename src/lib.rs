...
mod component {
    ...
    /// Generate a UUID.
    #[act_tool(description = "Generate a UUID (v4 random or v7 time-ordered)", read_only)]
    fn uuid(
    ...
    #[act_tool(description = "Generate a cryptographically random integer in a range", read_only)]
    fn random_number(
